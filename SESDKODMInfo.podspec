...
Pod::Spec.new do |s|
  s.name             = 'SESDKODMInfo'
  s.version          = '0.1.0'
  s.summary          = 'A short description of SESDKODMInfo.'
...
TODO: Add long description of the pod here.
  ...
  s.author           = { 'solarengine-sdk' => 'baixin.pan@mobvista.com' }
  s.source           = { :git => 'https://github.com/solarengine-sdk/SESDKODMInfo.git', :tag => s.version.to_s }
  # s.social_media_url = 'https://twitter.com/<TWITTER_USERNAME>'

  s.ios.deployment_target = '10.0'

  s.source_files = 'SESDKODMInfo/Classes/**/*'
  
  # s.resource_bundles = {
  #   'SESDKODMInfo' => ['SESDKODMInfo/Assets/*.png']
  # }
